//
//  CardStreamlinedFavouriteView.swift
//  phy-browser
//
...
class CardStreamlinedFavouriteView: CardView, UIGestureRecognizerDelegate {
    ...
    var contentBackgroundDefaultHeight: CGFloat = 170
